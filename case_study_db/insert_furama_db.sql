...
insert into employee (e_name,e_birthday,e_card_id,e_salary,e_phone_number,e_email,e_address,p_id,lv_id,dp_id)
...
insert into customer(ct_id,c_name,c_birthday,c_gender,c_card_id,c_phone_number,c_email,c_address)
...
insert into service_type(st_name)
values('Villa'),('House'),('Room');

insert into service(s_name,s_area,s_rental_cost,s_max_people,s_room_standard,s_description_other,s_pool_area,s_floors,s_free_service,rt_id,st_id)
...
insert into accompany_service(as_name, as_price,as_unit,as_status)
...
select * from accompany_service	;

insert into contract(cont_date_start,cont_date_end, cont_deposits,e_id,c_id,s_id)
...
insert into contract_detail(cont_id,as_id,quantity)
values	(2,4,5),
		(2,5,8),
		(2,6,15),
		(3,1,1),
