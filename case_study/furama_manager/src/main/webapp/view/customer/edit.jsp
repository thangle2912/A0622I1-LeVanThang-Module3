...
<div class="container">
    <div>
        <div class="row">
            <div class="col-12">
                <a href="/customer">
                    <button type="button" class="btn btn-primary" style="margin: 10px">Quay lại danh sách</button>
                </a>
            </div>
        </div>
        <h3>${mess}</h3>
        <form class=" g-3" action="/customer?action=edit" method="post">
            <div class="row">
                <input type="text" class="form-control" id="id" name="id" value="${customer.getId()}" hidden>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input max="2004-01-01" min="1922-01-01" type="date" class="form-control" id="birthday"
                           name="birthday" value="${customer.getBirthdayAdd()}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="phoneNumber" name="phoneNumber" value="${customer.getPhoneNumber()}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="idCard" name="idCard" value="${customer.getId_card()}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <label class="form-label">Loại khách hàng : ${customer.getCustomerType().getName()}</label>
